	...
	element(by.buttonText("Submit")).click().then(function()
			...
			element(by.name("name")).sendKeys("M").then(function()
				...
				//	element.all(by.tagName("tr")).each(function(item)
							//{
					//	item.element(by.css("[class='col-sm-1 col-md-1 text-center'] strong")).getText().then(function(text){
							//element(by.xpath("(//td[@class='col-sm-1 col-md-1 text-center'])[4]/strong")).getText().then(function(text){
							//console.log("HI")
						//expect(text).toBe("900000")
						//})
